 ...
 */
public class ScoreboardEntryRecyclerViewAdapter extends RecyclerView.Adapter<ScoreboardEntryRecyclerViewAdapter.ViewHolder> {

    private final ArrayList<ScoreboardEntry> values;
     ...
     */
    ScoreboardEntryRecyclerViewAdapter(ArrayList<ScoreboardEntry> items) {
        values = items;
    }
